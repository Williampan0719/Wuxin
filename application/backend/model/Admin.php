...
class Admin extends BaseModel
{
    ...
    {
        return Admin::where('admin_id', $adminId)->field('admin_name,admin_mobile,is_super,remark')->find();
    }
    ...
    public function adminList(int $page, int $size, string $keyword)
    {
        ...
        field('admin_id,admin_name,admin_mobile,is_super,status,create_at,remark,login_ip,login_at,city')
