...
class Utils
{
     ...
     * @return array
     */
    public static function treeList($list, $pk = 'id', $pid = 'pid', $child = 'children', $root = 0){
        $tree     = array();
        $packData = array();
    ...
    //生成短网址
    public static function shortLinkX(string $url)
    {
        $c_url='http://api.t.sina.com.cn/short_url/shorten.json';
        $data=[
            'source'=>'3271760578',
            'url_long'=>$url,
        ];
        $jsonData = Curl::buildHttp($c_url, $data, 'get');
